...
import (
	"fmt"
	configDb "github.com/TeslaMode1X/firstAssignmentADVPROG/statistics/config/db"
	configSrv "github.com/TeslaMode1X/firstAssignmentADVPROG/statistics/config/server"
